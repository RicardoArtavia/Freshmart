...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
         ...
         <p> usuario : <span><?= $fetch_users['name']; ?></span></p>
         <p> correo : <span><?= $fetch_users['email']; ?></span></p>
         <p> tipo de usuario : <span style=" color:<?php if($fetch_users['user_type'] == 'admin'){ echo 'orange'; }; ?>"><?= $fetch_users['user_type']; ?></span></p>
         <a href="admin_users.php?delete=<?= $fetch_users['id']; ?>" onclick="return confirm('borrar usuario?');" class="delete-btn">eliminar</a>
      </div>
      <?php
      }
      ?>
